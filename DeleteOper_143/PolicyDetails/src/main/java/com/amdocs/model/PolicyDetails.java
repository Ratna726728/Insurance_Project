...
public class PolicyDetails {
	...
	public String toString() {
		return "PolicyDetails [policy_id=" + policy_id + ", policy_number=" + policy_number + ", policy_effective_date="
				+ policy_effective_date + ", policy_expiry_date=" + policy_expiry_date + ", payment_option="
				+ payment_option + ", total_amount=" + total_amount + ", policy_status=" + policy_status + ", created_date="
				+ created_date + ", additional_info=" + additional_info + "]";
	}
